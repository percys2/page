...
Only local raster images referenced by image-overrides.js or index.html and
...
def original_urls(root: Path) -> list[str]:
    ...
    overrides = (root / "image-overrides.js").read_text(encoding="utf-8")
    match = re.search(
...
def main():
    ...
    manifest_path = root / "responsive-images.js"
