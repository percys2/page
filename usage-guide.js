(function () {
  ...
  const questions = [
    ...
    { id: "neopigg-optimo-plus", topic: "cerdos", question: "¿Cuál es la diferencia entre el programa NeoPigg Óptimo y Plus?", keywords: "lechones destete programa edades fases", answer: `<p>Son dos calendarios de edades para las mismas cuatro fases. En <strong>Óptimo</strong> los cambios se hacen un poco antes; en <strong>Plus</strong> cada fase dura unos días más. Lo importante es seguir las cuatro fases de un mismo programa, contando la edad desde el nacimiento.</p><div class="guide-table-wrap" role="region" aria-label="Edades NeoPigg" tabindex="0"><table><caption>Edades por fase (días de vida)</caption><thead><tr><th scope="col">Fase</th><th scope="col">Óptimo</th><th scope="col">Plus</th></tr></thead><tbody><tr><th scope="row">${link(24)}</th><td>5–27</td><td>5–30</td></tr><tr><th scope="row">${link(25)}</th><td>28–34</td><td>31–39</td></tr><tr><th scope="row">${link(37)}</th><td>35–43</td><td>40–48</td></tr><tr><th scope="row">${link(26)}</th><td>44–70</td><td>49–70</td></tr></tbody></table></div><a class="guide-inline-link" href="#guia-cerdos">Ver la guía completa de cerdos con calendario y calculadora →</a>` },
    ...
    { id: "cambio-alimento", topic: "manejo", question: "¿Cómo hago el cambio de una etapa de alimento a la siguiente?", keywords: "transicion cambio etapa mezclar dias diarrea rechazo", answer: `<p>Las edades de cambio de cada programa están en las fichas y en las <a href="#guias">guías por animal</a>. Como <strong>recomendación general de manejo</strong> (no es una indicación del catálogo), muchos productores hacen la transición de forma gradual durante 3 a 5 días, mezclando el alimento nuevo con el anterior en proporciones crecientes, para que los animales no rechacen el alimento ni tengan trastornos digestivos.</p><p>Si el cambio coincide con otro manejo estresante (vacunación, traslado, destete), conviene separarlos unos días. Ante cualquier duda, consultanos indicando la especie, la edad y el alimento actual.</p>` },
    { id: "cuanto-dura-saco", topic: "manejo", question: "¿Cuánto tiempo me dura un saco de 100 lb?", keywords: "rendimiento saco dias calcular sacos cuantos necesito", answer: `<p>Depende de cuántos animales tenés y de su etapa. Las calculadoras de las guías te dan la respuesta con tus propios números:</p><ul><li><a href="#guia-pollos">Pollos de engorde</a>: alimento por etapa y total del lote, con calendario de cambios.</li><li><a href="#guia-ponedoras">Gallinas ponedoras</a>: sacos por mes según la cantidad de gallinas.</li><li><a href="#guia-cerdos">Cerdos</a>: sacos por etapa, programa y línea.</li><li><a href="#guia-caballos">Caballos</a>: ración diaria de Forrajina según el peso.</li></ul>` },
  ];
